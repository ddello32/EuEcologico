...
public class SyncMarkerSetFetchNotConfirmed extends Fragment {

    static interface TaskCallbacks {

        void onFetchNotConfirmedPreExecute();

        void onFetchNotConfirmedProgressUpdate(int percent);

        void onFetchNotConfirmedCancelled();

        void onFetchNotConfirmedPostExecute(JSONObjectsList result);
    }

    private TaskCallbacks taskCallbacks;
    private FetchNotConfirmedMarkerSetSynchronizer markerSetSynchronizer;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        markerSetSynchronizer = new FetchNotConfirmedMarkerSetSynchronizer();
    ...
    private class FetchNotConfirmedMarkerSetSynchronizer extends AsyncTask<NameValuePairsList, Integer, JSONObjectsList> {

        @Override
        protected void onPreExecute() {
            if (taskCallbacks != null) {
                taskCallbacks.onFetchNotConfirmedPreExecute();
            }
        }
        ...
        protected JSONObjectsList doInBackground(NameValuePairsList... nameValuePairsLists) {
            ...
            // Fetch from not_confirmed.
            try {
                JSONObject jObj = jsonParser.makeHttpRequest("http://euecologico2.net16.net/fetchnotconfirmedaddedmarker.php", "POST", nameValuePairsLists[0]);
                if (jObj != null) {
        ...
        protected void onProgressUpdate(Integer... percent) {
            if (taskCallbacks != null) {
                taskCallbacks.onFetchNotConfirmedProgressUpdate(percent[0]);
            }
        }
        ...
        protected void onPostExecute(JSONObjectsList result) {
            if (taskCallbacks != null) {
                taskCallbacks.onFetchNotConfirmedPostExecute(result);
            }
        }
    }
}
