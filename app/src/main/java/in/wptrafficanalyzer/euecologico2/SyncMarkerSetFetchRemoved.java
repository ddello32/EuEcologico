...
public class SyncMarkerSetFetchRemoved extends Fragment {

    static interface TaskCallbacks {

        void onFetchRemovedPreExecute();

        void onFetchRemovedProgressUpdate(int percent);

        void onFetchRemovedCancelled();

        void onFetchRemovedPostExecute(JSONObjectsList result);
    }

    private TaskCallbacks taskCallbacks;
    private FetchRemovedMarkerSetSynchronizer markerSetSynchronizer;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        markerSetSynchronizer = new FetchRemovedMarkerSetSynchronizer();
    ...
    private class FetchRemovedMarkerSetSynchronizer extends AsyncTask<NameValuePairsList, Integer, JSONObjectsList> {

        @Override
        protected void onPreExecute() {
            if (taskCallbacks != null) {
                taskCallbacks.onFetchRemovedPreExecute();
            }
        }
        ...
        protected JSONObjectsList doInBackground(NameValuePairsList... nameValuePairsLists) {
            ...
            // Fetch from removed.
            try {
                JSONObject jObj = jsonParser.makeHttpRequest("http://euecologico2.net16.net/fetchnotconfirmedremovedmarker.php", "POST", nameValuePairsLists[0]);
                if (jObj != null) {
        ...
        protected void onProgressUpdate(Integer... percent) {
            if (taskCallbacks != null) {
                taskCallbacks.onFetchRemovedProgressUpdate(percent[0]);
            }
        }
        ...
        protected void onPostExecute(JSONObjectsList result) {
            if (taskCallbacks != null) {
                taskCallbacks.onFetchRemovedPostExecute(result);
            }
        }
    }
}
